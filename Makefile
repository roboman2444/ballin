...
OBJECTS = ballinengine.o matrixlib.o mathlib.o glfwmanager.o glmanager.o vbomanager.o hashtables.o stringlib.o modelmanager.o shadermanager.o filesys.o viewportmanager.o cvarmanager.o entitymanager.o
